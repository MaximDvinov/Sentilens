...
internal val primary = Color(0xFF3269FF)
internal val onPrimary = Color(0xffffffff)

internal val secondary = Color(0xFF171C26)
internal val onSecondary = Color(0xffffffff)

internal val error = Color(0x1aff4500)
internal val onError = Color(0xFFFF4500)

internal val background = Color(0xFF0E121A)
