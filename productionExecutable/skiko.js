...
var ASM_CONSTS = {
  1877440: ($0) => { _releaseCallback($0) },  
 1877465: ($0) => { return _callCallback($0).value ? 1 : 0; },  
 1877509: ($0) => { return _callCallback($0).value; },  
 1877545: ($0) => { return _callCallback($0).value; },  
 1877581: ($0) => { return _callCallback($0).value; },  
 1877617: ($0) => { _callCallback($0); }
};
